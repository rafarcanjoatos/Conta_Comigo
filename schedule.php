    		...
    		<form name="insert_schedule" method="post" action="php_files/schedule/insertschedule.php">            
    			...
    			<div class="row">
        			<div class="col-md-7">
            			...
            			<input class="form-control" maxlength="14" type="text" autocomplete="off" placeholder="999.999.999-99" name="cpf" id="cpf" style="display:none" onkeyup="validarCpf('cpf', document.getElementById('cpf').value);">
            		</div>
            		<div class="col-md-4">
