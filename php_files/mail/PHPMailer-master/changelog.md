...
* added callback function support
  - callback function parameters require_once:
...
graphic. Two attachments are require_onced in the email (one of the attachments
...
* fully compatible with E_STRICT error level
  - Please note:
    ...
    PHP5 installation. The fix is to modify your 'php.ini' file and require_once the
...
* implements new property to control VERP in class.smtp.php
  ...
  $mail->do_verp = true;
* POP-before-SMTP functionality require_onced, thanks to Richard Davey
  (see class.pop3.php & pop3_before_smtp_test.php for examples)
* require_onced example showing how to use PHPMailer with GMAIL
